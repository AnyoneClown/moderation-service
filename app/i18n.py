...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "tab_text": "📝 Text",
        "tab_audio": "🎤 Audio",
        "label_audio": "Upload audio file",
        "label_audio_hint": "(MP3, WAV, WebM, OGG, FLAC — max 25 MB)",
        "audio_drop_zone_text": "Drag & drop an audio file here, or",
        "audio_drop_zone_click": "click to browse",
        "audio_drop_zone_formats": "Supported: MP3, WAV, WebM, OGG, FLAC, M4A",
        "remove_audio": "✕ Remove audio",
        "btn_record": "🎙️ Record from Microphone",
        "btn_stop_record": "⏹️ Stop Recording",
        "recording_status": "Recording…",
        "btn_analyse_audio": "🔍 Analyse Audio",
        "or_record": "or record directly:",
        "input_type_audio": "🎤 Audio (transcribed)",
        "transcribed_text": "Transcribed Text",
        "audio_language": "Detected Language:",
        "err_no_audio": "Please provide an audio file or record from microphone.",
        "err_unsupported_audio": "Unsupported audio format:",
        "err_audio_too_large": "Audio file exceeds 25 MB limit.",
        "err_transcription_failed": "Audio transcription failed:",
        ...
        "xray_title": "🔬 X-Ray Analysis",
        "xray_subtitle": "Highlighted words show exactly which parts of the text triggered each detector. Hover for details.",
        "xray_legend_profanity": "Profanity / Toxic",
        "xray_legend_fraud": "Fraud / Scam",
        "xray_legend_sentiment": "Negative Sentiment",
    ...
    "uk": {
        ...
        "tab_text": "📝 Текст",
        "tab_audio": "🎤 Аудіо",
        "label_audio": "Завантажити аудіо файл",
        "label_audio_hint": "(MP3, WAV, WebM, OGG, FLAC — макс. 25 МБ)",
        "audio_drop_zone_text": "Перетягніть аудіо файл сюди, або",
        "audio_drop_zone_click": "натисніть для вибору",
        "audio_drop_zone_formats": "Підтримується: MP3, WAV, WebM, OGG, FLAC, M4A",
        "remove_audio": "✕ Видалити аудіо",
        "btn_record": "🎙️ Записати з мікрофона",
        "btn_stop_record": "⏹️ Зупинити запис",
        "recording_status": "Запис…",
        "btn_analyse_audio": "🔍 Аналізувати Аудіо",
        "or_record": "або запишіть напряму:",
        "input_type_audio": "🎤 Аудіо (транскрибоване)",
        "transcribed_text": "Транскрибований Текст",
        "audio_language": "Виявлена мова:",
        "err_no_audio": "Будь ласка, надайте аудіо файл або запишіть з мікрофона.",
        "err_unsupported_audio": "Непідтримуваний формат аудіо:",
        "err_audio_too_large": "Аудіо файл перевищує ліміт 25 МБ.",
        "err_transcription_failed": "Транскрипція аудіо не вдалась:",
        ...
        "xray_title": "🔬 X-Ray Аналіз",
        "xray_subtitle": "Виділені слова показують, які саме частини тексту спрацювали кожен детектор. Наведіть курсор для деталей.",
        "xray_legend_profanity": "Нецензурне / Токсичне",
        "xray_legend_fraud": "Шахрайство",
        "xray_legend_sentiment": "Негативний настрій",
